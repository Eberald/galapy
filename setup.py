...
def main():
    ...
    setup( name        = "galapy-fit",
           ...
           package_dir = {
               ...
               #============== CLOUDIA ============ #
               'galapy.CloudIA' : os.path.join('galapy', 'CloudIA'),
               'galapy.CloudIA.cli' : os.path.join('galapy', 'CloudIA', 'cli'),
               'galapy.CloudIA.scripts' : os.path.join('galapy', 'CloudIA', 'scripts'),
               'galapy.CloudIA.scripts.cloudy_common' : os.path.join('galapy', 'CloudIA', 'scripts', 'cloudy_common'),
               'galapy.CloudIA.scripts.cloudy_hii' : os.path.join('galapy', 'CloudIA', 'scripts', 'cloudy_hii'),
               'galapy.CloudIA.scripts.cloudy_pdr' : os.path.join('galapy', 'CloudIA', 'scripts', 'cloudy_pdr')
           },
           packages = [ 'galapy',
