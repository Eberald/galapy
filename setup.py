...
def main():
    ...
    setup( name        = "galapy-fit",
           ...
           package_dir = {
               ...
               #============== CLOUDIA ============ #
               'galapy.spectroscopy' : os.path.join('galapy', 'spectroscopy'),
               'galapy.spectroscopy.cloudia' : os.path.join('galapy', 'spectroscopy', 'cloudia'),
               'galapy.spectroscopy.utils' : os.path.join('galapy', 'spectroscopy', 'utils'),
               'galapy.spectroscopy.utils.physics' : os.path.join('galapy', 'spectroscopy', 'utils', 'physics'),
               'galapy.spectroscopy.utils.hii' : os.path.join('galapy', 'spectroscopy', 'utils', 'hii'),
               'galapy.spectroscopy.utils.pdr' : os.path.join('galapy', 'spectroscopy', 'utils', 'pdr')
           },
           packages = [ 'galapy',
